                                    ...
                                    <div class="card-block p-t-25">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            ...
                                            %>
                                             <tr>
                                               <td><%= i %></td>
                                               <td><%=type.getSellerName() %></td>
                                               <td><%=type.getSellerEmail() %></td> 
                                               <td><%=type.getSellerPhone() %></td> 
                                               <td><%=type.getSellerAddress() %></td> 
                                               <%-- <td>
                                                
                                              <form method="post" action="<%=request.getContextPath() %>/Controller">
                                                 <input type="hidden" name="actionCode" value="deletePublisher">
                                                <input type="hidden" name="deleteAdminUserID" value="<%= type.getPublisherID() %>">
